...
def append_signal_journal(
    ...
    try:
        ...
        row = {
            ...
            "buy_trend_score": _side_value(buy, "trend_score"),
            "sell_trend_score": _side_value(sell, "trend_score"),
            "buy_confirm_score": _side_value(buy, "confirm_score"),
            "sell_confirm_score": _side_value(sell, "confirm_score"),
            "buy_entry_score": _side_value(buy, "entry_score"),
            "sell_entry_score": _side_value(sell, "entry_score"),
